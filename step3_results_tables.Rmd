...
### Again, lots of repeat code. Try to generalise what you're doing above into a single function that does this and then you don't need to repeat huge code chunks all the time. See Step 1 example of a type of function that can do this. Try to understand that and then this problem will be easy to tackle
...
### NOTE: Yefeng. OK, here below you're doing the correlation between effects within studies? This isn't quite clear. Maybe a bit more annotation is needed here.
