...
# Loading packages
  pacman::p_load(metafor, # meta-analysis 
                 ...
                 lme4,
                 rptR);source('./functions/functions.R')
```
...
`F1 sex` = c(if_else(aic2_brain_development_RR$F1_sex_test == "+", "+", "NA"), round(ranking_brain_development_RR[5], 3)), delta_AICc = c(aic2_brain_development_RR$delta, NA), Weight = c(aic2_brain_development_RR$weight, NA)) -> table.top2.models_brain_development_RR


# Saving
  write.csv(table.top2.models_brain_development_RR, file = './results/csv/table.top2.models_brain_development_RR.csv', row.names = FALSE, col.names = TRUE)
...
`F1 sex` = c(if_else(aic2_genes_RR$F1_sex_test == "+", "+", "NA"), round(ranking_genes_RR[4], 3)), delta_AICc = c(aic2_genes_RR$delta, NA), Weight = c(aic2_genes_RR$weight, NA)) -> table.top1.models_genes_RR


# Saving
  write.csv(table.top1.models_genes_RR, file = './results/csv/table.top1.models_genes_RR.csv', row.names = FALSE, col.names = TRUE)
...
```{r}
table.top2.models_brain_development_RR %>% kable(digits = 3)
```
...
```{r}
table.top1.models_genes_RR %>% kable(digits = 3)
```
...
```{r contour-enhanced funnel plots}
...
# Residual funnel plot 1
  ...
  funnel.behavior_RR.1 <- rma.mv(yi = RR,
                                 V = cov_VRR_behavior,
                                 random = list(~1|strain, ~1|study_ID, ~1|ES_ID),
                                 mods = ~manipulation_mode + F0_sex_exercise,
                                 method = 'REML',
                                 data = behavior)
...
#dev.off()
  ...
  png(file = './results/Figures/funnel.behavior.RR.1.png', height = 8, width = 8, bg = "white", units = "in", type = c("windows"), res = 400)
  funnel(funnel.behavior_RR.1 , yaxis = 'seinv', level = c(90, 95, 99), shade = c('white', '#CC79A7', '#56B4E9'),pch = 21, refline = 0, legend = T)  
  dev.off()
...
funnel.behavior_RR.2 <- rma.mv(yi = RR,
                               V = cov_VRR_behavior,
                               random = list(~1|strain, ~1|study_ID, ~1|ES_ID),
                               mods = ~manipulation_mode + F0_sex_exercise + sqrt(VRR),
                               method = 'REML',
                               data = behavior)


  png(file = './results/Figures/funnel.behavior.RR.2.png', height = 8, width = 8, bg = "white", units = "in", type = c("windows"), res = 400)
...
# Residual funnel plot 1
  ...
  png(file = './results/Figures/funnel.brain_development.RR.1.png', height = 8, width = 8, bg = "white", units = "in", type = c("windows"), res = 400)
...
# Residual funnel plot 2
  funnel.brain_development_RR.2 <- rma.mv(yi = RR,
                                          V = cov_VRR_brain_development,
                                          random = list(~1|strain, ~1|study_ID, ~1|ES_ID),
                                          mods = ~manipulation_mode + sqrt(VRR),
                                          method = 'REML',
                                          data = brain_development)


  png(file = './results/Figures/funnel.brain_development.RR.2.png', height = 8, width = 8, bg = "white", units = "in", type = c("windows"), res = 400)
...
# Residual funnel plot 1
  ...
  png(file = './results/Figures/funnel.genes_RR.1.png', height = 8, width = 8, bg = "white", units = "in", type = c("windows"), res = 400)
...
# Residual funnel plot 2
  ...
  png(file = './results/Figures/funnel.genes_RR.2.png', height = 8, width = 8, bg = "white", units = "in", type = c("windows"), res = 400)
...
# Residual funnel plot 1
  ...
  funnel.behavior_CVR.1 <- rma.mv(yi = CVR,
                                  V = cov_VCVR_behavior,
                                  random = list(~1|strain, ~1|study_ID, ~1|ES_ID),
                                  mods = ~F1_sex_test + F0_sex_exercise,
                                  method = 'REML',
                                  data = behavior)

  
  png(file = './results/Figures/funnel.behavior_CVR.1.png', height = 8, width = 8, bg = "white", units = "in", type = c("windows"), res = 400)
...
# Residual funnel plot 2
  ...
  funnel.behavior_CVR.2 <- rma.mv(yi = CVR,
                                  V = cov_VCVR_behavior,
                                  random = list(~~1|strain, ~1|study_ID, ~1|ES_ID),
                                  mods = ~F1_sex_test + F0_sex_exercise + sqrt(VCVR),
                                  method = 'REML',
                                  data = behavior)


  png(file = './results/Figures/funnel.behavior_CVR.2.png', height = 8, width = 8, bg = "white", units = "in", type = c("windows"), res = 400)
...
# residual funnel plot 1
  ...
  png(file = './results/Figures/funnel.brain_development_CVR.1.png', height = 8, width = 8, bg = "white", units = "in", type = c("windows"), res = 400)
...
# Residual funnel plot 2
  ...
  png(file = './results/Figures/funnel.brain_development_CVR.2.png', height = 8, width = 8, bg = "white", units = "in", type = c("windows"), res = 400)
...
# Residual funnel plot 1
  ...
  png(file = './results/Figures/funnel.genes_CVR.1.png', height = 8, width = 8, bg = "white", units = "in", type = c("windows"), res = 400)
...
# Residual funnel plot 2
  funnel.genes_CVR.2 <- rma.mv(yi = CVR,
                               V = cov_VCVR_genes,
                               random = list(~1|strain, ~1|study_ID, ~1|ES_ID),
                               mods = ~F0_sex_exercise + F1_sex_test + sqrt(VCVR),
                               method = 'REML',
                               data = genes)


  png(file = './results/Figures/funnel.genes_CVR.2.png', height = 8, width = 8, bg = "white", units = "in", type = c("windows"), res = 400)
...
behavior %>% mutate(ymin = pred.Egger_behavior_RR$ci.lb, 
  ...
  labs(x = "sqrt(Sampling variance)", y = 'Cognition (lnRR)',  size = expression(paste('Precision (1/SE)'))) +    
...
png(filename = './results/Figures/Egger_cognition_RR.png', height = 4, width = 6, units = "in", type = "windows", res = 400)
Egger_behavior_RR.p
dev.off()
...
brain_development %>% mutate(ymin = pred.Egger_brain_development_RR$ci.lb, 
  ...
  geom_smooth(aes(y = ymax), method = "loess", se = FALSE, lty = "dotted", lwd = 0.6, colour = "#D55E00") + 
  geom_smooth(aes(y = pred), method = "loess", se = FALSE, lty = 2, lwd = 0.6, colour = "black") + 
  labs(x = "sqrt(Sampling variance)", y = 'Brain structure (lnRR)',  size = expression(paste('Precision (1/SE)'))) + 
  guides(fill = "none", colour = "none") + 
  theme_bw() + 
  theme(legend.position = c(0, 1), legend.justification = c(0, 1)) + 
  theme(legend.direction = "horizontal") + 
...
png(filename = './results/Figures/Egger_brain_structure_RR.png', height = 4, width = 6, units = "in", type = "windows", res = 400)
...
behavior %>% mutate(ymin = pred.Egger_behavior_CVR$ci.lb, 
  ...
  geom_smooth(aes(y = ymax), method = "loess", se = FALSE, lty = "dotted", lwd = 0.6, colour = "#D55E00") + 
  geom_smooth(aes(y = pred), method = "loess", se = FALSE, lty = 2, lwd = 0.6, colour = "black") +
  labs(x = "sqrt(Sampling variance)", y = 'Cognition (lnCVR)',  size = expression(paste('Precision (1/SE)'))) +    
  guides(fill = "none", colour = "none") + 
  theme_bw() + 
  theme(legend.position = c(0, 1), legend.justification = c(0, 1)) + 
  theme(legend.direction = "horizontal") + 
...
png(filename = './results/Figures/Egger_cognition_CVR.png', height = 4, width = 6, units = "in", type = "windows", res = 400)
...
brain_development %>% mutate(ymin = pred.Egger_brain_development_CVR$ci.lb, 
  ...
  geom_smooth(aes(y = ymax), method = "loess", se = FALSE, lty = "dotted", lwd = 0.6, colour = "#D55E00") + 
  geom_smooth(aes(y = pred), method = "loess", se = FALSE, lty = 2, lwd = 0.6, colour = "black") + 
  labs(x = "sqrt(Sampling variance)", y = 'Brain structure (lnCVR)',  size = expression(paste('Precision (1/SE)'))) + 
  guides(fill = "none", colour = "none") + 
  theme_bw() + 
  theme(legend.position = c(0, 1), legend.justification = c(0, 1)) + 
  theme(legend.direction = "horizontal") + 
...
png(filename = './results/Figures/Egger_brain_structure_CVR.png', height = 4, width = 6, units = "in", type = "windows", res = 400)
...
# Losia
  ...
  plot_Losia_mean <- plot_Losia_mean + 
                    labs(y = 'mean_ML') + labs(x = "mean_YFY") +
...
# Yong
  ...
  plot_Yong_mean <- plot_Yong_mean + 
                    labs(y = 'mean_ZFY') + labs(x = "mean_YFY") +
...
# Losia
  ...
  plot_Losia_logmean <- plot_Losia_logmean + 
                         labs(y = 'log(mean_ML)') + labs(x = 'log(mean_YFY)') +
...
# Yong
  ...
  plot_Yong_logmean <- plot_Yong_logmean + 
                       labs(y = 'log(mean_ZFY)') + labs(x = 'log(mean_YFY)') +
...
# Losia
  ...
  plot_Losia_logse <- plot_Losia_logse + 
                       labs(y = 'log(se_ML)') + labs(x = 'log(se_YFY)') +
...
# Yong
  ...
  plot_Yong_logse <- plot_Yong_logse + 
                     labs(y = 'log(se_ZFY)') + labs(x = 'log(se_YFY)') +
