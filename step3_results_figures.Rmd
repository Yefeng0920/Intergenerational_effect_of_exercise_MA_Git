...
# ggsave(plot = fig.conception, filename = './results/Figures/fig.1.pdf', height = 7, width = 9, dpi = 300,  device = cairo_pdf)
  ...
  pdf(file = './results/Figures/fig.1.pdf', height = 7, width = 9)
  fig.conception
  dev.off()
...
### 5. Cognition (original category: Neurobehavior)

```{r Cognition improvement and variability}
#***************************************************************#
#--------------------- Improvement (lnRR) ----------------------#
#***************************************************************#
...
# Neurobehavior
 ...
 # Plotting
  ...
  scale_y_discrete(labels = c('Cognition')) +
...
pdf(file = "./results/Figures/fig.behavior.RR.pdf", width = 16, height = 22)
fig.behavior.RR
dev.off()
...
pdf(file = "./results/Figures/fig.behavior.CVR.pdf", width = 16, height = 22)
fig.behavior.CVR
dev.off()
...
### 6. Brain structure (original category: Brain development)

```{r Brain structure improvement and variability}
#***************************************************************#
#--------------------- Improvement (lnRR) ----------------------#
#***************************************************************#
...
# Brain development
 ...
 # Plotting
  ...
  scale_y_discrete(labels = c('Brain structure')) +
  theme(panel.grid = element_blank(),
        panel.border = element_rect(size = 1.2, colour = "black", fill = NA),
        axis.ticks = element_line(size = 0.9, color = 'black'),
        axis.ticks.length = unit(0.15, 'cm'),
...
pdf(file = "./results/Figures/fig.brain.RR.pdf", width = 16, height = 22)
fig.brain_structure.RR
dev.off()
...
pdf(file = "./results/Figures/fig.brain.CVR.pdf", width = 16, height = 22)
fig.brain_structure.CVR
dev.off()
...
pdf(file =  "./results/Figures/fig.genes.RR.pdf", width = 16, height = 22)
fig.genes.RR
dev.off()
...
# Subsetting data
 # RR
  ...
  colnames(overlap.RR.max) <- c("Cognition", "Brain structure", "Brain growth factors")
  colnames(overlap.RR.ave) <- c("Cognition", "Brain structure", "Brain growth factors")
  colnames(overlap.RR.min) <- c("Cognition", "Brain structure", "Brain growth factors")
 ...
 # CVR
  ...
  colnames(overlap.CVR.max) <- c("Cognition", "Brain structure", "Brain growth factors")
  colnames(overlap.CVR.ave) <- c("Cognition", "Brain structure", "Brain growth factors")
  colnames(overlap.CVR.min) <- c("Cognition", "Brain structure", "Brain growth factors")
